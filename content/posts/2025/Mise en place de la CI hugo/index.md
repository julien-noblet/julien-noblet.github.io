...
description: >-
  "Découvrez comment configurer une intégration continue (CI) pour déployer un
  site Hugo sur GitHub Pages."
---
...
On crée donc un fichier {{% include
displayName="`.github/workflows/mon-site.yml` :" src=gh-pages.yml lang=yaml %}}
